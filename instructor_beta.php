...
<ul id="slide-out" class="sidenav">
      ...
      <li><a href="instructorinit_beta.php#live-session"><i class="material-icons">live_help</i>Start Live Session</a></li>
      <li><a href="instructorinit_beta.php#statistics">Course attendance</a></li>
      <li><div class="divider"></div></li>
      <li><a class="subheader">Resources</a></li>
      <li><a class="waves-effect" href="instructorinit_beta.php#lectures">Previous Lectures</a></li>
  ...
  <div class="col s12 m6">
    <div class="card">
      <div class="card-content">
        ...
        <a class='dropdown-trigger btn' href='#' data-target='dropdown1'>Drop Me!</a>
          ...
          <div class="col s12 m6">
            <div class="card">
                <div class="card-content" style="overflow:auto;" id='Ratings'>
                <div class="progress">
                  <div class="determinate" id='progress-bar' style="width:<?php 
            ...
            <span class="card-title">Lecture Rating</span>
            </div>
    ...
    <script>
      ...
      if (!('webkitSpeechRecognition' in window)) {
        ...
        recognition.onresult = function(event) {
          ...
          $.ajax({
            type: "POST",
            url: "exec_beta.php",
            data: { param: final_transcript, lang: 'hi'},
      ...
      $.ajax({
        type: "POST",
        url: "exec_beta.php",
        data: { param: interim_transcript , lang: 'hi'},
        success: function(response){
